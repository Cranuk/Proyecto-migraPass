<div>
    <div wire:click.prevent="openModal" class="button add" title="Agregar aplicacion">
    ...
    <div class="modal">
        <div class="form-style">
            <h3>Añadir nueva aplicacion</h3>
            <label for="company" class="label-text">Nombre de la aplicacion</label>
