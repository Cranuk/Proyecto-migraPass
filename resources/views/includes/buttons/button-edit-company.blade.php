<button type="button" wire:click.stop="editCompany({{ $companyId }})" wire:loading.attr="disabled" wire:target="editCompany" class="button cancel small" title="Editar empresa">

    <span wire:loading.remove wire:target="editCompany">
    ...
    <span wire:loading wire:target="editCompany">
