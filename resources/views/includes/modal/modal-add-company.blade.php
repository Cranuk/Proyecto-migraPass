<div class="modal">
    <form wire:submit="saveCompany" class="form-style">
        ...
        <div class="modal-buttons">
            <button type="button" class="button cancel" wire:click="closeModal" wire:loading.remove wire:target="saveCompany">
                Cancelar
            </button>

            <button type="submit" class="button add" wire:loading.attr="disabled" wire:target="saveCompany">
                <span wire:loading.remove wire:target="saveCompany">Crear</span>
